...
// Hash P3 File to P3
let h3 = _filelock.encrypt(p3, p3, "aes-256-ctr", "sha256", salt, "base64", { logger: console.log });
console.log("[hasher._fileHash]: File hashed");
console.log(h3);

// DeHash P3 File hashed content to P3
let r3 = _filelock.decrypt(p3, p3, "aes-256-ctr", "sha256", salt, "base64", { logger: console.log });
